function results = run_double_pendulum(u, u_test, noise, Data, dData, Data_test, dData_test,dt,tspan,tspan_test)
...
[dData_Es,Data_Es]=Get_Sim_Data(@(t,z,inp)Sindy_ODE_RHS(t,z,inp),state0_test,u_test,tspan_test,0,Control,Shuffle);
% if ProvidedData ~= 1
